...
public class MovieSummaryInfo implements Parcelable {
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator(){
        @Override
        public MovieSummaryInfo createFromParcel(Parcel src) {
            return new MovieSummaryInfo(src);
        }

        @Override
        public MovieSummaryInfo[] newArray(int size) {
            return new MovieSummaryInfo[size];
        }
    };
